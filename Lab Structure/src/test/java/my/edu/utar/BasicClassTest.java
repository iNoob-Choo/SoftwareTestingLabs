...
public class BasicClassTest {
	...
	public void testAddStringsToListV1(){
		...
		String[] inputStr = linesRead.get(2);
		String[] expectedResult = linesRead.get(2);
		bc.setStrLimit(2);
	...
	public void testGetTotalStringLengthV1(){
		...
		int expectedResult = Integer.parseInt(tempStr[2]);
		bc.setStrLimit(3);
		bc.addStringsToList(inputStr);
	...
	public void testGetTotalStringLengthV2(){
		...
		String[] inputStr = linesRead.get(1);
		String[] tempStr = linesRead.get(2);
		int expectedResult = Integer.parseInt(tempStr[1]);
		bc.setStrLimit(3);
		bc.addStringsToList(inputStr);
		int result = bc.getTotalStringLength();
		assertEquals(expectedResult, result);
