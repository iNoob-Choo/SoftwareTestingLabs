...
public class MethodUsingNewStudent {
	...
	// Given an array of Student objects, stuArray, this method locates all
	// objects // from this array whose age variable is more than the
	// parameter ageLimit
