...
public class SomeMethodsClass {
	...
	// Given an int parameter age, the method checks to see whether // age falls
	// within a certain numeric range. If it does, the // method returns true;
	...
	// the method returns
	// the first String element in the array
	// whose length is larger than strLength. 
	//If there are no  elements whose length is larger than
	// strLength, than a null  value is returned
	...
	// Given an array of Strings and an int parameter pos, the method returns
	// the String element in the array // at index position pos 
